...
parser.add_argument('-e', '--elastic', help='Elasti search', action='store_true')
parser.add_argument('-c', '--couchdb', help='CouchDB' ,action='store_true')
parser.add_argument('-m', '--mongodb', help='MongoDB', action='store_true')
parser.add_argument('-k', '--kibana', help='Kibana', action='store_true')
group.add_argument('-f', '--first', help='First page', default=None, type=int)
group.add_argument('-l', '--last', help='Last page', default=None, type=int)
out.add_argument('-o', '--output', help='Output file', default=None, type=str)
